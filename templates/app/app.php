...
<div
    ...
    x-data='{
        ...
        init() { this.load(); },
        load() {
            if (["dashboard", "guru"].includes(this.active)) {
                this.items = [];
                this.loading = false;
                return;
            }
    ...
    <div class="elvd-shell">
        ...
        <section class="elvd-main">
            ...
            <div class="elvd-table-panel" x-show="!['dashboard', 'tahun-ajaran', 'kelas', 'mata-pelajaran', 'jadwal-pelajaran', 'guru'].includes(active)">
